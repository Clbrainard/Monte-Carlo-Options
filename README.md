...
Part of a larger portfolio of option pricing implementations, including a [binomial tree pricer](https://github.com/Clbrainard/Binomial-Options). For more detailed information on the LSM Monte Carlo method for American options look [here](https://github.com/Clbrainard/Binomial-Options/notes.pdf)
